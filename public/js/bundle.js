...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYm9iYXNpY3Vhbml0YSIsImEiOiJjazhsbjFtN3kwMTJtM2VtZGZycmRncHo2In0.Ok-w8ga810FfKvSP4CCxzA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/bobasicuanita/ck8lofrjj0v1d1iodtexrkels',
    scrollZoom: false // center: [-118.105557, 34.104282],
    // zoom: 4,
    // interactive: false
...
var stripe = Stripe('pk_test_Jkpfl48vYkYMC0k9JXbzoHTG00MYFBzsaz');
...
if (logOutBtn) {
  logOutBtn.addEventListener('click', _login2.logout);
}
...
},{"../js/login":"login.js","../js/mapbox":"mapbox.js","./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
